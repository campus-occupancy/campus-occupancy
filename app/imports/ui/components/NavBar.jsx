  ...
  render() {
    ...
    return (
      <Menu style={menuStyle} attached="top" borderless>
        ...
        <Menu.Item as={NavLink} id="dataMenuItem" activeClassName="active" exact to="/data" key='data'>Data</Menu.Item>
        <Menu.Item as={NavLink} id="editDataMenuItem" activeClassName="active" exact to="/edit" key='profiles'>Import Data</Menu.Item>
