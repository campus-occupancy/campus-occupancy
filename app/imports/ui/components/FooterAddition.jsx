  ...
  render() {
    ...
    return (
        <Container textAlign="left" style={footercolor}>
          ...
          <div style={header}><Icon name='copyright outline' size='small' style={marginFix}/>2020 University of Hawaiʻi at Mānoa • 2500 Campus Road • Honolulu, HI 96822 • (808) 956-8111</div>
        </Container>
    );
  }
}
